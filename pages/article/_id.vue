  ...
  <section>
    ...
    <div class="arcMata articleDetailBox" style="background: transparent">
      <div class="arcMataInfo">
        ...
        <div class="view">
          <span>{{article.meta.comments}}</span>条评论
        </div>
      </div>
            ...
            <div class="userInfo">
              <div class="userInfoMata">
                ...
                <span>
                  <i
                    class="iconfont"
                  >{{currentSystem(comment.agent) === 'Mac' ? '&#xe64b;' : '&#xec83;'}}</i>
                  {{currentSystem(comment.agent)}}
                </span>
                <span>
                  <i class="iconfont">&#xe68f;</i>
                  {{getBrowser(comment.agent)}}
                </span>
                <span>
                  <i class="iconfont">&#xe662;</i>
                  {{comment.country}} - {{comment.city}}
                </span>
              </div>
            </div>
                  ...
                  <div class="replayItemContet">
                    <div class="userInfoMata">
                      ...
                      <span>
                        <i
                          class="iconfont"
                        >{{currentSystem(replys.agent) === 'Mac' ? '&#xe64b;' : '&#xec83;'}}</i>
                      ...
                      <span>
                        <i class="iconfont">&#xe662;</i>
                        {{replys.country}} - {{replys.city}}
                      </span>
                    </div>
                    <div class="replyPepole" v-if="replys.to.name">
                      回复
                      <a :href="replys.to.site" target="_blank">{{replys.to.name}}：</a>
                    </div>
